...
class Cards
{
    ...
    */
    ...
    getHigherArmorCard(){
        return this.cardsCollection.sort((a,b) => a.armor - b.armor)[0];
    }


    getHigherPlayedCard(){
        return this.cardsCollection.sort((a,b) => a.played - b.played)[0];
    }

    getHigherVictoryCard(){
        return this.cardsCollection.sort((a,b) => a.victory - b.victory)[0];
    }
